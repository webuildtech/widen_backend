              ...
              <tr>
                <td class="sm-p-6" style="border-radius: 8px; background-color: #fffffe; padding: 24px 36px; border: 1px solid #e2e8f0">
                  ...
                  <div>
                    ...
                    <h3 style="font-size: 18px; line-height: 28px; font-weight: 600; color: #0f172a; margin-top: 24px; margin-bottom: 0">
                      Plano informacija:
                    </h3>
                    ...
                    <div style="margin-top: 24px; margin-bottom: 0">
                      <a href="{{ $appUrl }}/dashboard/plan" style="display: inline-block; text-decoration: none; padding: 16px 24px; font-size: 16px; line-height: 1; border-radius: 4px; color: #fffffe; background-color: #15803d" class="hover-bg-green-800">
