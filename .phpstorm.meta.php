...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cors.exposed_headers.Access-Control-Expose-Headers' => 'string',
            ...
            'filesystems.links./Users/przewalskip/Projects/tenisas/backend/public/storage' => 'string',
            'games.frontend_path' => 'string',
            'games.group_frontend_path' => 'string',
            'games.list_frontend_path' => 'string',
            'games.max_guests_per_join' => 'integer',
            'games.capacities' => 'array',
            'games.per_page' => 'integer',
            'games.cancel_unfilled_minutes_before' => 'integer',
            'games.announcement_cron' => 'string',
            'litecom.default' => 'string',
            'litecom.connections.primary.base_url' => 'NULL',
            'litecom.connections.primary.token' => 'NULL',
            'litecom.connections.primary.timeout' => 'integer',
            'litecom.connections.primary.retries' => 'integer',
            'litecom.connections.primary.mqtt_host' => 'NULL',
            'litecom.connections.primary.mqtt_port' => 'NULL',
            'litecom.connections.primary.mqtt_username' => 'NULL',
            'litecom.connections.primary.mqtt_password' => 'NULL',
            'litecom.connections.secondary.base_url' => 'NULL',
            'litecom.connections.secondary.token' => 'NULL',
            'litecom.connections.secondary.timeout' => 'integer',
            'litecom.connections.secondary.retries' => 'integer',
            'litecom.connections.secondary.mqtt_host' => 'NULL',
            'litecom.connections.secondary.mqtt_port' => 'NULL',
            'litecom.connections.secondary.mqtt_username' => 'NULL',
            'litecom.connections.secondary.mqtt_password' => 'NULL',
            ...
            'mail.to_address' => 'string',
            'makecommerce.shop_id' => 'string',
            'makecommerce.public_key' => 'string',
            'makecommerce.secret_key' => 'string',
            'makecommerce.environment' => 'string',
            ...
            'services.omnisend.api_key' => 'string',
            ...
            'soulbscription.database.cancel_migrations_autoloading' => 'boolean',
            'soulbscription.feature_tickets' => 'boolean',
            'soulbscription.models.feature' => 'string',
            'soulbscription.models.feature_consumption' => 'string',
            'soulbscription.models.feature_ticket' => 'string',
            'soulbscription.models.feature_plan' => 'string',
            'soulbscription.models.plan' => 'string',
            'soulbscription.models.subscriber.uses_uuid' => 'boolean',
            'soulbscription.models.subscription' => 'string',
            'soulbscription.models.subscription_renewal' => 'string',
...
'auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider','auth.guards.user.driver','auth.guards.user.provider',
'auth.guards.admin.driver','auth.guards.admin.provider','auth.guards.sanctum.driver','auth.guards.sanctum.provider','auth.providers.users.driver',
'auth.providers.users.model','auth.providers.admins.driver','auth.providers.admins.model','auth.passwords.users.provider','auth.passwords.users.table',
'auth.passwords.users.expire','auth.passwords.users.throttle','auth.passwords.admins.provider','auth.passwords.admins.table','auth.passwords.admins.expire',
'auth.passwords.admins.throttle','auth.password_timeout','cache.default','cache.stores.array.driver','cache.stores.array.serialize',
...
'cors.exposed_headers.Access-Control-Expose-Headers','cors.max_age','cors.supports_credentials','data.date_format','data.date_timezone',
...
'filesystems.disks.s3.throw','filesystems.links./Users/przewalskip/Projects/tenisas/backend/public/storage','games.frontend_path','games.group_frontend_path','games.list_frontend_path',
'games.max_guests_per_join','games.capacities','games.per_page','games.cancel_unfilled_minutes_before','games.announcement_cron',
'litecom.default','litecom.connections.primary.base_url','litecom.connections.primary.token','litecom.connections.primary.timeout','litecom.connections.primary.retries',
'litecom.connections.primary.mqtt_host','litecom.connections.primary.mqtt_port','litecom.connections.primary.mqtt_username','litecom.connections.primary.mqtt_password','litecom.connections.secondary.base_url',
'litecom.connections.secondary.token','litecom.connections.secondary.timeout','litecom.connections.secondary.retries','litecom.connections.secondary.mqtt_host','litecom.connections.secondary.mqtt_port',
'litecom.connections.secondary.mqtt_username','litecom.connections.secondary.mqtt_password','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','mail.to_address',
'makecommerce.shop_id','makecommerce.public_key','makecommerce.secret_key','makecommerce.environment','media-library.disk_name',
...
'services.google.client_id','services.google.client_secret','services.google.redirect','services.omnisend.api_key','session.driver',
...
'soulbscription.database.cancel_migrations_autoloading','soulbscription.feature_tickets','soulbscription.models.feature','soulbscription.models.feature_consumption','soulbscription.models.feature_ticket',
'soulbscription.models.feature_plan','soulbscription.models.plan','soulbscription.models.subscriber.uses_uuid','soulbscription.models.subscription','soulbscription.models.subscription_renewal',
'typescript-transformer.auto_discover_types','typescript-transformer.collectors','typescript-transformer.transformers','typescript-transformer.default_type_replacements.DateTime','typescript-transformer.default_type_replacements.DateTimeImmutable',
'typescript-transformer.default_type_replacements.Carbon\\CarbonInterface','typescript-transformer.default_type_replacements.Carbon\\CarbonImmutable','typescript-transformer.default_type_replacements.Carbon\\Carbon','typescript-transformer.output_file','typescript-transformer.writer',
'typescript-transformer.formatter','typescript-transformer.transform_to_native_enums','typescript-transformer.transform_null_to_optional','hashing.driver','hashing.bcrypt.rounds',
...
'broadcasting.connections.log.driver','broadcasting.connections.null.driver','view.paths','view.compiled','excel.exports.chunk_size',
...
'role_or_permission','set_locale',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','admins.index','admins.store','admins.show','admins.update',
'admins.destroy','index','store',
'show','update','destroy','plans.index','plans.store','plans.show','plans.update',
'plans.destroy','plan-court-type-rules.index','plan-court-type-rules.show','plan-court-type-rules.update',
'groups.index','groups.store','groups.show','groups.update','groups.destroy','intervals.index','intervals.store','intervals.show','intervals.update',
'intervals.destroy','courts.index','courts.store',
'courts.show','courts.update','courts.destroy',
'game-groups.index','game-groups.store','game-groups.show','game-groups.update','game-groups.destroy','games.index','games.store','games.show',
'games.update','games.destroy','downtimes.index','downtimes.store','downtimes.show',
'downtimes.update','downtimes.destroy','discount-codes.index','discount-codes.store','discount-codes.show',
'discount-codes.update','discount-codes.destroy','reservations.index',
'reservations.store','reservations.destroy',);
        registerArgumentsSet('views', 
'emails.companyForm','emails.contactUs','emails.maizzle.games.canceled','emails.maizzle.games.joined','emails.maizzle.games.newGames',
'emails.maizzle.invoiceGenerate','emails.maizzle.payments.balanceTopUp','emails.maizzle.payments.planSubscribe','emails.maizzle.payments.reservationPaid','emails.maizzle.reservationUnpaidReminder',
'emails.maizzle.subscriptionExpirationReminder','emails.planSubscribeAdmin','pdfs.invoice','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'auth.failed','auth.password','auth.throttle','auth.letter_sent','auth.token_error',
'auth.password_changed','auth.invalid_current_password','auth.login.invalid_credentials','auth.login.account_blocked_by_employer','auth.social.login_failed',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','validation.availability.start_time.required',
'validation.availability.start_time.format','validation.availability.end_time.required','validation.availability.end_time.format','validation.availability.price.required','validation.availability.price.min',
'validation.availability.date_from.before','validation.availability.date_to.after','validation.availability.slot.end_after_start','validation.availability.slot.no_overlap','validation.games.courts_court_type',
'validation.games.capacity_below_taken_spots','validation.game_groups.name_required','validation.game_groups.has_games','discount_codes.not_found','discount_codes.inactive',
'discount_codes.not_yet_valid','discount_codes.expired','discount_codes.usage_limit_reached','discount_codes.only_for_court_reservations','discount_codes.not_valid_for_selected_courts',
'downtimes.end_time_after_start_time','emails.signature','games.default_title','games.not_available','games.already_started',
'games.already_joined','games.not_enough_spots','games.duplicate_guest','games.guest_already_joined','games.level_not_for_sport',
'games.canceled_not_filled','games.canceled_by_admin','games.removed_by_admin','games.edit_from_games_page','games.cannot_edit_past',
'games.manage_from_games_page','games.mail.greeting','games.mail.greeting_no_name','games.mail.signature','games.mail.new_games_subject',
'games.mail.new_games_intro','games.mail.new_games_button','games.mail.new_games_all_button','games.mail.new_games_unsubscribe','games.mail.joined_subject',
'games.mail.joined_intro','games.mail.joined_added_intro','games.mail.joined_button','games.mail.canceled_subject','games.mail.canceled_intro',
'games.mail.canceled_refund','games.mail.details','games.mail.sport','games.mail.group','games.mail.no_group',
'games.mail.date','games.mail.time','games.mail.court','games.mail.price','games.mail.reason',
'invoices.download.not_allowed','litecom.unavailable_try_later','litecom.zones.sync.success','litecom.zones.on.success','litecom.zones.off.success',
'newsletter.subscribed','payments.provider_unavailable','payments.unauthorized','plans.prices.delete_forbidden_active_subscriptions','plans.delete_forbidden_default_plan',
'plans.delete_forbidden_active_subscriptions','reservations.cannot_edit_paid_reservation','reservations.cannot_edit_canceled_reservation','reservations.something_went_wrong','subscriptions.subscribe_forbidden_default_plan',
'lt.0',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_TIMEZONE',
'APP_URL','APP_FRONTEND_URL','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
...
'MAIL_FROM_NAME','MAIL_TO_ADDRESS','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION',
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','MAKECOMMERCE_ENVIRONMENT','MAKECOMMERCE_SHOP_ID',
'MAKECOMMERCE_PUBLIC_KEY','MAKECOMMERCE_SECRET_KEY','LOCAL_NODE_PATH','LOCAL_NPM_PATH','GOOGLE_CLIENT_ID',
'GOOGLE_CLIENT_SECRET','OMNISEND_API_KEY','LITECOM_DEFAULT','LITECOM_ZONES_TTL','LITECOM_INDEX_TTL',);
