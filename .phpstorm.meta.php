...
'filesystems.disks.s3.throw','filesystems.links./Users/przewalskip/Projects/tenisas/backend/public/storage','games.frontend_path','games.max_guests_per_join','games.capacities',
'games.cancel_unfilled_minutes_before','litecom.default','litecom.connections.primary.base_url','litecom.connections.primary.token','litecom.connections.primary.timeout',
'litecom.connections.primary.retries','litecom.connections.primary.mqtt_host','litecom.connections.primary.mqtt_port','litecom.connections.primary.mqtt_username','litecom.connections.primary.mqtt_password',
'litecom.connections.secondary.base_url','litecom.connections.secondary.token','litecom.connections.secondary.timeout','litecom.connections.secondary.retries','litecom.connections.secondary.mqtt_host',
'litecom.connections.secondary.mqtt_port','litecom.connections.secondary.mqtt_username','litecom.connections.secondary.mqtt_password','logging.default','logging.deprecations.channel',
...
'sanctum.csrf-cookie','admins.index',
'admins.store','admins.show','admins.update','admins.destroy','index','store','show','update',
'destroy','plans.index',
'plans.store','plans.show','plans.update','plans.destroy','plan-court-type-rules.index',
'plan-court-type-rules.show','plan-court-type-rules.update','groups.index','groups.store',
'groups.show','groups.update','groups.destroy','intervals.index',
'intervals.store','intervals.show','intervals.update','intervals.destroy','courts.index','courts.store','courts.show','courts.update',
'courts.destroy','downtimes.index','downtimes.store','downtimes.show',
'downtimes.update','downtimes.destroy','discount-codes.index','discount-codes.store','discount-codes.show',
'discount-codes.update','discount-codes.destroy','reservations.index','reservations.store',
'reservations.destroy',);
        registerArgumentsSet('views', 
'emails.companyForm','emails.contactUs','emails.maizzle.invoiceGenerate','emails.maizzle.payments.balanceTopUp','emails.maizzle.payments.planSubscribe',
'emails.maizzle.payments.reservationPaid','emails.maizzle.reservationUnpaidReminder','emails.maizzle.subscriptionExpirationReminder','pdfs.invoice','laravel-exceptions-renderer::components.card',
...
'validation.availability.date_from.before','validation.availability.date_to.after','validation.availability.slot.end_after_start','validation.availability.slot.no_overlap','discount_codes.not_found',
'discount_codes.inactive','discount_codes.not_yet_valid','discount_codes.expired','discount_codes.usage_limit_reached','discount_codes.only_for_court_reservations',
'discount_codes.not_valid_for_selected_courts','downtimes.end_time_after_start_time','games.default_title','invoices.download.not_allowed','litecom.unavailable_try_later',
'litecom.zones.sync.success','litecom.zones.on.success','litecom.zones.off.success','newsletter.subscribed','payments.provider_unavailable',
'payments.unauthorized','plans.prices.delete_forbidden_active_subscriptions','plans.delete_forbidden_default_plan','plans.delete_forbidden_active_subscriptions','reservations.cannot_edit_paid_reservation',
'reservations.cannot_edit_canceled_reservation','reservations.something_went_wrong','subscriptions.subscribe_forbidden_default_plan','lt.0',);
